...
SRS_API_PORT = 1985
# settings.py
CELERY_BROKER_URL = 'redis://192.168.224.3:6379:6379/0'
CELERY_RESULT_BACKEND = 'redis://192.168.224.3:6379:6379/0'
...
CACHES = {
    'default': {
        ...
        'LOCATION': os.environ.get('REDIS_CACHE_URL', 'redis://192.168.224.3:6379:6379/1'),
        'OPTIONS': {
