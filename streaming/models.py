...
def generate_stream_key():
    ...
    You could also use a random string from secrets if desired.
    """
...
class StreamingConfiguration(models.Model):
    ...
    including RTMP endpoints, stream keys, platform, etc.
    """
    ...
    # Pull links (raw text for multiple URLs, if any)
