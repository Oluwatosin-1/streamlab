...
class StreamingSessionAdmin(admin.ModelAdmin):
    list_display = ("configuration", "status", "session_start", "session_end", "viewers_count")
...
class ChatMessageAdmin(admin.ModelAdmin):
    ...
    search_fields = ("user__username", "streaming_session__configuration__stream_title", "text")
